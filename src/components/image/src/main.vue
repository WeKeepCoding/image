<template>
  <div class="J-image">
    <slot v-if="loading" name="placeholder">
      <div class="J-image__placeholder"></div>
    </slot>
    <slot v-else-if="error" name="error">
      <div class="J-image__error">el.image.error</div>
    </slot>
    <img
      v-else
      class="J-image__inner"
      v-bind="$attrs"
      v-on="$listeners"
      @click="clickHandler"
      :src="src"
      :style="imageStyle"
      :class="{
        'J-image__inner--center': alignCenter,
        'J-image__preview': preview,
      }"
    />
