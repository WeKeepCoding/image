<template>
  <transition name="viewer-fade">
    <div tabindex="-1" ref="J-image-viewer__wrapper" class="J-image-viewer__wrapper" :style="{ 'z-index': viewerZIndex }">
...
export default {
  ...
  mounted() {
    ...
    this.$refs['J-image-viewer__wrapper'].focus();
  },
  destroyed() {
